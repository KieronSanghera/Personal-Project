...
class EnvConfig(BaseSettings):
    ...
    @property
    def is_debug(self):
        log_level = self.log_level.lower() if isinstance(self.log_level, str) else self.log_level
    ...
    def post_log_level(self) -> Self:
        ...
        if isinstance(self.log_level, str):
            ...
            if log_level_upper in {"CONFIG", "ERROR", "WARNING", "INFO", "DEBUG", "NOTSET"}:
                ...
                try:
                    ...
                    print(f"ERROR: Invalid LOG_LEVEL value, Defaulting to log level INFO" - {e})
